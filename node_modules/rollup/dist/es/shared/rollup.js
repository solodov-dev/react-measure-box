...
class Graph {
    ...
    async build(entryModuleIds, manualChunks, inlineDynamicImports) {
        ...
        const { entryModules, manualChunkModulesByAlias } = await this.parseModules(entryModuleIds, manualChunks);
        ...
        const chunks = this.generateChunks(entryModules, manualChunkModulesByAlias, inlineDynamicImports);
    ...
    generateChunks(entryModules, manualChunkModulesByAlias, inlineDynamicImports) {
        const chunks = [];
    ...
    includeStatements(entryModules) {
    ...
    async parseModules(entryModuleIds, manualChunks) {
...
export { createCommonjsModule, ensureArray, fseventsImporter, getCjsExportFromNamespace, parseInputOptions, parseOutputOptions, rollup, rollupInternal, unwrapExports, version, warnUnknownOptions, watch };
